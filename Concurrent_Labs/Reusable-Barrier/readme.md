...
### A re-usable barrier is the same problem as the simple barrier but we want to be able to use a loop within the barrier. A simple barrier
### does not use a loop, a re-usable barrier does. 
